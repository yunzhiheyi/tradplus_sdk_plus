export 'package:tradplus_sdk_plus/tp_native.dart';
export 'package:tradplus_sdk_plus/tp_native_view.dart';
export 'package:tradplus_sdk_plus/tp_interstitial.dart';
export 'package:tradplus_sdk_plus/tp_rewardVideo.dart';
export 'package:tradplus_sdk_plus/tp_banner.dart';
export 'package:tradplus_sdk_plus/tp_banner_view.dart';
export 'package:tradplus_sdk_plus/tp_splash.dart';
export 'package:tradplus_sdk_plus/tp_offerwall.dart';
export 'package:tradplus_sdk_plus/tp_splash_view.dart';
export 'package:tradplus_sdk_plus/tp_listener.dart';
export 'package:tradplus_sdk_plus/tp_interactive.dart';
export 'package:tradplus_sdk_plus/tp_interactive_view.dart';
export 'package:tradplus_sdk_plus/ttd_uid2.dart';
import 'package:tradplus_sdk_plus/tp_listener.dart';
...
class TradplusSdk {
  ...
  /// Android 返回 -1 (不支持)
  Future<int> trackingAuthorizationStatus() async {
